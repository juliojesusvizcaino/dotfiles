...
--     },
--     keys = {
--       { "<leader>z", desc = "CodeCompanion" },
--       { "<leader>za", "<cmd>CodeCompanionChat Toggle<cr>", mode = { "n", "v" }, desc = "Toggle Chat" },
--       { "<leader>zp", "<cmd>CodeCompanionActions<cr>", mode = { "n", "v" }, desc = "Actions" },
--       { "<leader>zc", "<cmd>CodeCompanionChat Add<cr>", mode = "v", desc = "Chat Add" },
--     },
--     init = function()
